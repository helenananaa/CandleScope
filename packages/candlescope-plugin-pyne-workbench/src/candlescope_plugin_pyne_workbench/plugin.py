...
_CONTRACT_LOCALIZATIONS = {
    ...
    "th": {
        "Pyne workbench contribution is not invokable": "คอนทริบิวชันโต๊ะงาน Pyne เรียกใช้ไม่ได้",
        "Pyne session is not active": "เซสชัน Pyne ยังไม่ทำงาน",
        "preview must be a boolean": "preview ต้องเป็นบูลีน",
        "workbench completion token is stale": "โทเค็นเสร็จสิ้นของโต๊ะงานหมดอายุแล้ว",
        "workbench phase is invalid": "เฟสของโต๊ะงานไม่ถูกต้อง",
        "lookbackBars must be from 2 to 5000": "lookbackBars ต้องอยู่ระหว่าง 2 ถึง 5000",
        "paramsJson must be bounded JSON text": "paramsJson ต้องเป็นข้อความ JSON ที่จำกัดความยาว",
        "paramsJson is invalid JSON": "paramsJson ไม่ใช่ JSON ที่ถูกต้อง",
        "paramsJson must contain an object": "paramsJson ต้องมีออบเจ็กต์",
        "bar fields are invalid": "ฟิลด์แท่งไม่ถูกต้อง",
        "Host returned no market bars": "Host ไม่ได้ส่งแท่งตลาดกลับมา",
        "Host bars are not all final": "แท่งจาก Host ยังปิดไม่ครบ",
        "Host returned invalid bars": "Host ส่งแท่งที่ไม่ถูกต้องกลับมา",
        "capabilityUnavailable": "ความสามารถ {permission} ไม่พร้อมใช้งาน",
        "boundedString": "{key} ต้องเป็นสตริงที่จำกัดความยาว",
    },
    "nl": {
        "Pyne workbench contribution is not invokable": "De Pyne-werkbankbijdrage kan niet worden aangeroepen",
        "Pyne session is not active": "De Pyne-sessie is niet actief",
        "preview must be a boolean": "preview moet een boolean zijn",
        "workbench completion token is stale": "Het voltooiingstoken van de werkbank is verlopen",
        "workbench phase is invalid": "De werkbankfase is ongeldig",
        "lookbackBars must be from 2 to 5000": "lookbackBars moet tussen 2 en 5000 liggen",
        "paramsJson must be bounded JSON text": "paramsJson moet begrensde JSON-tekst zijn",
        "paramsJson is invalid JSON": "paramsJson is ongeldige JSON",
        "paramsJson must contain an object": "paramsJson moet een object bevatten",
        "bar fields are invalid": "Kaarsvelden zijn ongeldig",
        "Host returned no market bars": "De host gaf geen marktkaarsen terug",
        "Host bars are not all final": "Niet alle hostkaarsen zijn gesloten",
        "Host returned invalid bars": "De host gaf ongeldige kaarsen terug",
        "capabilityUnavailable": "Capaciteit {permission} is niet beschikbaar",
        "boundedString": "{key} moet een begrensde tekenreeks zijn",
    },
}
